...
ЧТО СЧИТАТЬ ЗНАНИЕМ: архитектурные решения, код (функции/классы/модули), инфраструктура, инсайты, факты о пользователях.
ЧТО ПРОПУСКАТЬ: trivial tool results (read/glob/grep без нового контекста), повторение, служебные детали.
